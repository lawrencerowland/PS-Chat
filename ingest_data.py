...
if __name__ == "__main__":
    #### example of delete namespaces: pdf_ingest.delete_namespaces ("Praxis")
    ###### Comment or uncomment the following lines to ingest the pdf you want
    ...
    ###### Comment or uncomment the following lines to ingest the graph you want
    ...
    graph_ingest.upload_graph_to_pinecone()
